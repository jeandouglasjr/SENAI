...
app.post('/produto', async (req, res) => {
    ...
    if(!nome || !preco || !descricao) {
        res.status(400).send({ mensagem: 'Os campos nome, preco e descricao são obrigatórios'})
        return
    }
    await conexao.query('INSERT INTO PRODUTO(nome, preco, descricao) VALUES ($1, $2, $3)', [nome, preco, descricao])
