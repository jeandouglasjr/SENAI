...
const Animal = () => {
  ...
  const buscarAnimais = async () => {
    ...
            ...animal,
            id: animal.id,
            // 1. CALCULA A IDADE e armazena no novo campo 'idade'
            idade: calcularIdade(animal.nascimento), // <-- NOVO CAMPO
            
            // 2. Formatação de data (Ainda útil para 'data_cadastro')
            data_cadastro: animal.data_cadastro ? new Date(animal.data_cadastro).toLocaleDateString() : 'N/A',
            
            // 3. O campo 'nascimento' não precisa de formatação de data para a tabela, 
            // mas manteremos o valor original (string ISO) para o filtro funcionar corretamente
          }));
            ...
            <Table striped bordered hover responsive>
              <thead className="table-primary">
                <tr>
                  ...
                  <th>Ações</th> {/* Coluna para botões de ação (Editar/Deletar) */}
                </tr>
              </thead>
              <tbody>
